...
import duck.develop.calculator.di.Resources
...
val network = module {
    ...
    factory { get<Retrofit>().create(KeyService::class.java) }
    factory<ConfigService> { ConfigServiceImpl(get()) }

    //Module
    single {
        Retrofit.Builder()
            .baseUrl(/*get<String>(named(Resources.BASE_URL))*/androidContext().getString(R.string.base_url))
